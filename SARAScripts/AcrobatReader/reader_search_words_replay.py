...
if __name__ == '__main__':
    ...
    try:
        ...
        perform_click_event("Tap", 501.303741, 393.692413, 0.026000, "Activity")
        ...
        post_action(0.015678)
        perform_click_event("Tap", 225.686554, 888.306030, 0.055000, "Activity")
        post_action(2.384755)
        perform_click_event("Tap", 648.099854, 204.839966, 0.069000, "Activity")
        post_action(0.015577)
        perform_click_event("Tap", 650.097107, 211.834503, 0.072000, "Activity")
        post_action(0.828838)
        perform_swipe_event([(500.3051452636719, 295.7689208984375), (475.29913330078125, 454.6510314941406), (450.90130615234375, 978.510986328125), (448.56768798828125, 1022.0108642578125), (448.37725830078125, 1026.1982421875)], 0.136000)
        post_action(0.408581)
        perform_swipe_event([(497.3092956542969, 340.7337951660156), (491.317626953125, 357.72052001953125), (460.7867126464844, 637.5416259765625), (456.2391052246094, 827.0631713867188), (454.3689270019531, 944.67578125), (451.37310791015625, 1014.2105712890625), (450.3744812011719, 1022.201416015625), (450.3744812011719, 1023.2006225585938)], 0.131000)
        post_action(0.499644)
        perform_swipe_event([(507.2954406738281, 377.7049255371094), (497.2636413574219, 435.02581787109375), (491.317626953125, 673.3868408203125), (501.3037414550781, 855.1055908203125), (497.3092956542969, 949.5542602539062), (493.8984680175781, 1036.0997314453125), (493.3148498535156, 1062.57470703125), (493.3148498535156, 1063.16943359375)], 0.108500)
        post_action(0.303422)
        perform_swipe_event([(514.2857055664062, 444.6526184082031), (500.5833740234375, 575.4208984375), (499.3065185546875, 627.1892700195312), (500.6097412109375, 739.7774047851562), (500.3051452636719, 776.3934326171875)], 0.074500)
        post_action(1.547091)
        perform_key_event(4)
