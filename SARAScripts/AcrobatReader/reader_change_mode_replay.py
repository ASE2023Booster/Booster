...
if __name__ == '__main__':
    ...
    try:
        ...
        perform_click_event("Tap", 446.380035, 569.555054, 0.112000, "Activity")
        post_action(10.675155)
        perform_click_event("Tap", 75.894592, 1243.028931, 0.112000, "Activity")
        ...
        perform_click_event("Tap", 72.898750, 1233.036743, 0.111000, "Activity")
        post_action(1.419573)
        perform_click_event("Tap", 135.811371, 723.434814, 0.112000, "Dialog")
        post_action(3.667011)
        perform_click_event("DoubleTap", 336.532593, 675.472290, 0.085000, "Activity")
        post_action(0.107482)
        perform_click_event("Tap", 93.869629, 1228.040649, 0.068000, "Activity")
        post_action(1.315424)
        perform_click_event("Tap", 519.278809, 468.633881, 0.080000, "Dialog")
        ...
        perform_click_event("Tap", 94.868240, 1214.051514, 0.072000, "Activity")
        post_action(1.047186)
        perform_click_event("Tap", 578.196960, 850.335693, 0.072000, "Dialog")
        post_action(1.714921)
        perform_click_event("Tap", 93.869629, 1229.039795, 0.028000, "Activity")
        post_action(0.851146)
        perform_click_event("Tap", 600.166443, 835.347412, 0.055000, "Dialog")
        post_action(2.316978)
        perform_click_event("Tap", 520.277405, 708.446533, 0.125000, "Activity")
        post_action(3.302742)
        perform_key_event(4)
        post_action(2.254992)
        perform_click_event("Tap", 79.889046, 233.817337, 0.111000, "Activity")
