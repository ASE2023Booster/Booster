...
if __name__ == '__main__':
    ...
    try:
        ...
        post_action(1.374730)
        perform_click_event("Tap", 61.914009, 117.907883, 0.111000, "Activity")
        post_action(2.952491)
        perform_click_event("Tap", 589.181702, 102.919594, 0.095000, "Activity")
        post_action(1.403991)
        perform_click_event("Tap", 363.495148, 677.470703, 0.128000, "Dialog")
        post_action(2.207692)
        perform_click_event("Tap", 583.190002, 741.420776, 0.124000, "Dialog")
        post_action(0.000000)
