...
if __name__ == '__main__':
    ...
    try:
        ...
        perform_click_event("Tap", 491.317627, 572.552673, 0.112000, "Activity")
        post_action(1.287439)
        perform_click_event("Tap", 492.316223, 1222.045288, 0.125000, "Activity")
        post_action(1.440772)
        perform_click_event("Tap", 614.147034, 974.238892, 0.100000, "Dialog")
        post_action(1.907395)
        perform_key_event(4)
