...
if __name__ == '__main__':
    ...
    try:
        ...
        perform_click_event("Tap", 36.948685, 151.881348, 0.098000, "Activity")
        post_action(1.111483)
        perform_click_event("Tap", 261.636627, 227.822006, 0.168000, "Activity")
        post_action(1.074753)
        perform_click_event("Tap", 632.122070, 266.791565, 0.139000, "Activity")
        post_action(1.557179)
        perform_click_event("Tap", 166.768387, 817.361450, 0.168000, "Dialog")
        post_action(1.832710)
        perform_click_event("Tap", 644.105408, 257.798584, 0.241000, "Activity")
        post_action(1.146932)
        perform_click_event("Tap", 189.736481, 811.366089, 0.241000, "Dialog")
