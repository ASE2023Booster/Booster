...
if __name__ == '__main__':
    ...
    try:
        ...
        perform_click_event("Tap", 179.750351, 458.641693, 0.267000, "Activity")
        post_action(1.617931)
        perform_click_event("Tap", 669.070740, 910.288818, 0.167000, "Activity")
        post_action(1.629946)
        perform_click_event("Tap", 674.063843, 706.448059, 0.180000, "Activity")
        post_action(2.984740)
        perform_click_event("Tap", 646.102661, 595.534729, 0.128000, "Activity")
        post_action(1.851742)
        perform_click_event("Tap", 651.095703, 406.682281, 0.124000, "Activity")
        post_action(2.629137)
        perform_click_event("Tap", 54.923717, 80.936768, 0.111000, "Activity")
        post_action(0.000000)
