...
if __name__ == '__main__':
    ...
    try:
        ...
        perform_click_event("Tap", 503.300995, 206.838409, 0.265000, "Activity")
        post_action(3.073259)
        perform_click_event("Tap", 358.502075, 609.523804, 0.138000, "Activity")
        post_action(3.939472)
        perform_click_event("Tap", 95.866852, 1023.200623, 0.151000, "Activity")
        post_action(10.096579)
        perform_click_event("Tap", 665.076294, 71.943794, 0.137000, "Activity")
        post_action(0.687061)
        record_popup_window()
        post_action(7.772496)
        close_popup_window()
        post_action(2.339466)
        perform_click_event("Tap", 67.905685, 120.905540, 0.097000, "Activity")
        post_action(1.693150)
        perform_click_event("Tap", 65.908463, 218.829041, 0.168000, "Activity")
