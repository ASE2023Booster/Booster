...
if __name__ == '__main__':
    ...
    try:
        ...
        perform_click_event("Tap", 636.124817, 1199.138916, 0.042000, "Activity")
        post_action(1.412299)
        perform_click_event("Tap", 631.142883, 1038.246704, 0.041000, "Activity")
        ...
        perform_click_event("Tap", 355.497925, 1100.213867, 0.095000, "Activity")
        post_action(5.764774)
        perform_click_event("Tap", 281.642181, 953.248230, 0.142000, "Dialog")
        post_action(2.148161)
        perform_click_event("Tap", 58.954231, 108.903984, 0.099000, "Activity")
        post_action(0.953635)
        perform_click_event("Tap", 58.901527, 108.903198, 0.099000, "Activity")
        post_action(0.847928)
        perform_click_event("Tap", 581.203918, 731.409851, 0.069000, "Dialog")
        post_action(1.857043)
        perform_click_event("Tap", 634.119263, 1199.136597, 0.081000, "Activity")
        post_action(1.068469)
        perform_click_event("Tap", 637.115112, 894.379395, 0.068000, "Activity")
        post_action(2.488869)
        perform_click_event("Tap", 681.054077, 108.914909, 0.084000, "Activity")
        post_action(1.988365)
        perform_click_event("Tap", 169.819702, 1092.195190, 0.081000, "Activity")
        post_action(3.217517)
        perform_click_event("Tap", 357.529816, 1092.207642, 0.124000, "Activity")
        post_action(5.871903)
        perform_click_event("Tap", 269.642181, 954.254517, 0.128000, "Dialog")
        post_action(1.450198)
        perform_click_event("Tap", 59.947296, 111.903984, 0.099000, "Activity")
        post_action(1.068341)
        perform_click_event("Tap", 59.934814, 111.900856, 0.068000, "Activity")
        post_action(0.735336)
        perform_click_event("Tap", 595.173401, 727.423889, 0.086000, "Dialog")
