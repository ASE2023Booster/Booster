...
if __name__ == '__main__':
    ...
    try:
        ...
        print("===========Restoring=============")
        perform_click_event("Tap", 51.134521, 98.746277, 0.197000, "Activity")
        time.sleep(3.2)
        perform_click_event("Tap", 296.134521, 228.746277, 0.197000, "Activity")
        time.sleep(3.2)
        perform_click_event("Tap", 261.134521, 332.746277, 0.197000, "Activity")
        time.sleep(3.2)
        perform_click_event("Tap", 380.134521, 232.746277, 0.197000, "Activity")
        time.sleep(3.2)
        set_text("ch.sbb.mobile.android.b2c:id/text", "[0,192][720,244]", "hongkong")
        post_action(0.868924)
        perform_click_event("Tap", 203.134521, 600.746277, 0.197000, "Activity")
        time.sleep(3.2)
